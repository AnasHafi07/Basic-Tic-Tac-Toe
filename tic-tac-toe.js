...
function playTurn(player) {
    let newpost = prompt("Make your move " + player)
    
  
    
    if (validateMove(newpost) === true){
        markBoard(newpost, player);
        printBoard();
        
        if (checkWin(player) === true){
            console.log( "We have a winner chicken dinner!");
            return result = true;
        } else if (player === 'X'){
            playTurn('O')
        } else {
